...
(function () {
  ...
  function render() {
    ...
    section.innerHTML = '<div class="af-journey-steps" aria-label="' + esc(text.stepsLabel) + '">' + text.steps.map(function (step, i) { return '<span' + (i === 0 ? ' class="is-current"' : '') + '>' + esc(step) + '</span>' + (i < text.steps.length - 1 ? '<span aria-hidden="true">→</span>' : ''); }).join('') + '</div>' + '<h2 id="af-post-reading-title">' + text.heading + '</h2><p class="af-post-reading-intro">' + text.intro + '</p>' + related + '<nav class="af-next-actions" aria-label="Post-reading navigation"><a class="af-back" href="' + text.listUrl + '" data-af-event="view_item_list" data-af-label="case_studies" data-af-location="post_reading">' + text.list + '</a><a class="af-solution" href="' + solutionUrl + '" data-af-event="select_content" data-af-label="solution" data-af-location="post_reading">' + text.solution + '</a></nav>' + '<div class="af-cta-band"><h3>' + text.ctaTitle + '</h3><p>' + text.ctaSub + '</p>' + '<div class="af-cta-actions">' + '<a class="af-cta-doc" href="' + text.productUrl + '?req=doc#materials" data-af-event="cta_click" data-af-location="post_reading_cta" data-af-label="doc">' + text.ctaDoc + '</a>' + '<a class="af-cta-demo" href="' + text.productUrl + '?req=demo#materials" data-af-event="cta_click" data-af-location="post_reading_cta" data-af-label="demo">' + text.ctaDemo + '</a>' + '<p class="af-cta-hint">' + text.ctaHint + '</p></div></div>';
